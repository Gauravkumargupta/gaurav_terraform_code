resource "aws_cloudwatch_metric_alarm" "cpu-utilization" {
  ...
  statistic = "Average" //The statistic to apply to the alarm’s associated metric. Either of the following is supported: SampleCount, Average, Sum, Minimum, Maximum
